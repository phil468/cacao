...
class Container_39a361cb15 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_39a361cb15 $container)
			{
	...
	public function createServiceContainer(): Container_39a361cb15
	{
		return $this;
	}
